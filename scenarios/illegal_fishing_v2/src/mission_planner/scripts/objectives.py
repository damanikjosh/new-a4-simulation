"""Objectives reading utilities for mission planning"""
...
def get_points(obj_sheet):
    """
    Extract points from an objective sheet.
    
    Args:
        obj_sheet: A pandas DataFrame containing objective location data
...
def read_objectives(file_path):
    """
    Read objectives from an Excel file.
    
    Args:
        file_path: Path to the Excel file containing objectives
        
    Returns:
        tuple: Three lists of points (obj1_points, obj2_points, obj3_points)
    """
